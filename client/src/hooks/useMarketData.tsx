...
function useMarketData() {
  ...
  const connectToMarketData = (symbols: string[], exchangeId: number = 4) => {
    console.log('[MARKET DATA HOOK] Connecting to market data for symbols:', symbols, 'on exchange:', exchangeId);
